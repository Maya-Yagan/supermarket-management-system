...
public class EditUserController implements Initializable {
    ...
    private void setPositionMenuSelection(){
        managerCheckMenuItem.setSelected(selectedPositions.stream().anyMatch(r -> r.getName().equals("manager")));
        accountantCheckMenuItem.setSelected(selectedPositions.stream().anyMatch(r -> r.getName().equals("accountant")));
        depotEmployeeCheckMenuItem.setSelected(selectedPositions.stream().anyMatch(r -> r.getName().equals("depot_worker")));
        cashierCheckMenuItem.setSelected(selectedPositions.stream().anyMatch(r -> r.getName().equals("cashier")));
    }
